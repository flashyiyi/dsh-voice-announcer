...
const LANG_TEXTS: Record<string, Record<string, string>> = {
  zh: {
    ...
    aborted: '这轮对话被中止了',
    blocked: '这轮对话被阻塞了',
    'max-tokens': '这轮对话输出太长被截断了',
    interrupted: '这轮对话被打断了',
    roundThis: '这轮',
    roundN: '第 {n} 轮',
  ...
  en: {
    completed: 'This round of conversation has ended',
    error: 'This round of conversation had an error',
    aborted: 'This round of conversation was aborted',
    blocked: 'This round of conversation was blocked',
    'max-tokens': 'This round was cut off because the output was too long',
    interrupted: 'This round of conversation was interrupted',
  ...
  ja: {
    completed: 'この会話は終了しました',
    error: 'この会話でエラーが発生しました',
    aborted: 'この会話は中止されました',
    blocked: 'この会話はブロックされました',
    'max-tokens': '出力が長すぎてこの会話は切断されました',
    interrupted: 'この会話は中断されました',
    roundThis: 'この回',
    roundN: '第 {n} 回',
  ...
  ko: {
    completed: '이번 대화가 종료되었습니다',
    error: '이번 대화에서 오류가 발생했습니다',
    aborted: '이번 대화가 중단되었습니다',
    blocked: '이번 대화가 차단되었습니다',
    'max-tokens': '출력이 너무 길어 이번 대화가 잘렸습니다',
    interrupted: '이번 대화가 중단되었습니다',
    roundThis: '이번',
    roundN: '{n}번째',
  ...
  fr: {
    completed: 'Cette conversation est terminée',
    error: 'Cette conversation a rencontré une erreur',
    aborted: 'Cette conversation a été interrompue',
    blocked: 'Cette conversation a été bloquée',
    'max-tokens': 'Cette conversation a été coupée car la sortie était trop longue',
    interrupted: 'Cette conversation a été interrompue',
  ...
  de: {
    completed: 'Diese Unterhaltung ist beendet',
    error: 'Bei dieser Unterhaltung ist ein Fehler aufgetreten',
    aborted: 'Diese Unterhaltung wurde abgebrochen',
    blocked: 'Diese Unterhaltung wurde blockiert',
    'max-tokens': 'Diese Unterhaltung wurde abgeschnitten, weil die Ausgabe zu lang war',
    interrupted: 'Diese Unterhaltung wurde unterbrochen',
  ...
  ru: {
    completed: 'Этот разговор завершён',
    error: 'В этом разговоре произошла ошибка',
    aborted: 'Этот разговор был прерван',
    blocked: 'Этот разговор был заблокирован',
    'max-tokens': 'Этот разговор был обрезан, так как вывод был слишком длинным',
    interrupted: 'Этот разговор был прерван',
  ...
  es: {
    completed: 'Esta conversación ha terminado',
    error: 'Esta conversación tuvo un error',
    aborted: 'Esta conversación fue interrumpida',
    blocked: 'Esta conversación fue bloqueada',
    'max-tokens': 'Esta conversación se cortó porque la salida era demasiado larga',
    interrupted: 'Esta conversación fue interrumpida',
